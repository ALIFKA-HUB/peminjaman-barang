...
<div class="sidebar-menu">
    <ul class="menu">
        ...
        <li class="sidebar-item {{ request()->is('barang-rusak') ? 'active' : '' }}">
            <a href="{{ route('peminjaman.rusak') }}" class='sidebar-link'>
                <i class="bi bi-clock-history"></i>
                <span>Riwayat Rusak</span>
            </a>
        </li>
        <li class="sidebar-item {{ request()->is('daftar-sanksi') ? 'active' : '' }}">
            <a href="{{ route('peminjaman.sanksi') }}" class='sidebar-link'>
                <i class="bi bi-clock-history"></i>
